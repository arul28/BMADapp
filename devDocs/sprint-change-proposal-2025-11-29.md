...
- Change trigger: Added two new Solutioning workflows for the TEA agent in `apps/v0/lib/bmad-data.ts` — "Test Framework Setup" (`bmad framework`, id `solutioning-framework`) and "CI/CD Pipeline Setup" (`bmad ci`, id `solutioning-ci`).
